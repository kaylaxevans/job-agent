                ...
                <div style={s.card}>
                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
                    {(results.similarRoles || []).map((role, i) => (
                      <div key={i} style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "14px 16px", background: "#f8f7f4", borderRadius: "8px", border: "1px solid #e5e2db", flexWrap: "wrap", gap: "10px" }}>
                        <span style={{ fontSize: "14px", color: "#1a1a2e", fontWeight: 500 }}>{role}</span>
                        <div style={{ display: "flex", gap: "8px", flexWrap: "wrap" }}>
                          <a href={`https://www.linkedin.com/jobs/search/?keywords=${encodeURIComponent("entry level " + role)}&f_E=2`} target="_blank" rel="noopener noreferrer" style={{ background: "#0077b5", color: "#fff", borderRadius: "6px", padding: "6px 14px", fontSize: "11px", textDecoration: "none", fontFamily: "inherit", fontWeight: 600, display: "flex", alignItems: "center", gap: "5px" }}>
                          ...
                          <a href={`https://www.indeed.com/jobs?q=${encodeURIComponent("entry level " + role)}&explvl=entry_level`} target="_blank" rel="noopener noreferrer" style={{ background: "#003A9B", color: "#fff", borderRadius: "6px", padding: "6px 14px", fontSize: "11px", textDecoration: "none", fontFamily: "inherit", fontWeight: 600, display: "flex", alignItems: "center", gap: "5px" }}>
